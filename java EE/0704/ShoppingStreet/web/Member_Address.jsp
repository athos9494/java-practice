...
<%@ page import="club.banyuan.entity.Address" %>
...
<div class="i_bg bg_color">
    ...
    <div class="m_content">
        ...
        <div class="m_right">
            ...
            <div class="address">
                <%
                    Object o = session.getAttribute("addressList");
                    if(o != null ){
                        int i = 0;
                        ...
                        List<Address> addressList = (ArrayList<Address>)o;
                        for (Address address : addressList) {
                            String str = address.getRemark();
            ...
            <form action="address.do" id="myForm">
                ...
                <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td colspan="3" style="font-family:'宋体';">
                            <select class="jj" name="country" style="background-color:#f6f6f6;">
                                ...
                                <option value="赛博坦">赛博坦</option>
                                <option value="泰坦星">泰坦星</option>
                                <option value="瓦坎达">瓦坎达</option>
                            </select>
                    ...
                    <tr>
                        ...
                        <td style="font-family:'宋体';"><input type="text" name="userName" value="姓名" class="add_ipt" />（必填）</td>
                        <td align="right">电子邮箱</td>
                        <td style="font-family:'宋体';"><input type="text" value="12345678@qq.com" class="add_ipt" />（必填）</td>
                    </tr>
                    <tr>
                        <td align="right">详细地址</td>
                        <td style="font-family:'宋体';"><input type="text" name="detailAddress" value="世外桃源" class="add_ipt" />（必填）</td>
                ...
                <p align="right">
                    <a href="#">删除</a>&nbsp;<input type="submit" value="确认修改">
                    <%--                <a href="address.do" id="btn_a"  class="add_b" >确认修改</a>--%>
                </p>
            </form>
        </div>
    </div>
