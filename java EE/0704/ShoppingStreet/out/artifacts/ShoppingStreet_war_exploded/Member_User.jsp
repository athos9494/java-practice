        ...
        <span class="fr">
        	<span class="fl">
                      <%
                          ...
                          if(object != null){
                              user = (User)object;
                              out.print("<a href=Member_User.jsp>"+"欢迎， "+user.getMobile()+"</a>&nbsp;");
...
<div class="i_bg bg_color">
    ...
    <div class="m_content">
        ...
        <div class="m_right">
            ...
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="40%">用户ID：<span style="color:#555555;"><%=user.getId()%></span></td>
                    <td width="60%">邀请人：<span style="color:#555555;">邀请人姓名</span></td>
                </tr>
                <tr>
                    <td>电&nbsp; &nbsp; 话：<span style="color:#555555;"><%=user.getMobile()%></span></td>
                    <td>邮&nbsp; &nbsp; 箱：<span style="color:#555555;"><%=user.getEmail()%></span></td>
                </tr>
                <tr>
