    ...
    <div class="content mar_20">
        ...
        <div class="l_list">
            <div class="list_t">
                ...
                <span class="fr">共发现<%=request.getAttribute("size")%>件</span>
            </div>
            <div class="list_c">
                ...
                <ul class="cate_list">
                    ...
                    <%
                        Object object1 = request.getAttribute("productList");
                        if(object1 != null){
                            List<Product> productList = (ArrayList<Product>)object1;
                            for (Product product : productList) {
                                out.print("                    <li>\n" +
                                        "                        <div class=\"img\"><a href=\"detail.do?id="
                                        + product.getId()  +
