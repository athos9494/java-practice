...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div class="pro_des">
            ...
            <form id="addCartForm" action="addCart.do">
            <div class="des_join">
                <div class="j_nums">
                    <input id="num" type="text" value="1" name="num" class="n_ipt" />
                ...
                <span class="fl" ><!-- a onclick="ShowDiv_1('MyDiv1','fade1')"-->
                   <input type="image" src="images/j_car.png"/> </span>
            </div>
            </form>
        </div>
