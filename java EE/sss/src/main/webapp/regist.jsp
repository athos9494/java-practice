...
<title>购物街</title>
    <script>
        ...
        $(function() { $("#loginName").blur(function() {
            var loginName = this.value; $("#tdLoginName div").remove(); if(loginName != ""){
                $.get("validate.do", "loginName="+loginName, callBack);
//响应成功时的回调函数
              function callBack(data) {
                if(data == "false"){
                    $("#tdLoginName").append("<div><span style='color:#ff0000'>用户名
                    已经被注册</span></div>")
                }
            }//end of callBack()
        }else{
		...
		<div class="reg_c">
            ...
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="50">
                ...
                <td id="tdLoginName"><input type="text" id="loginName" name="loginName" value="" class="l_user" /></td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td><input type="text" name="userName" value="" class="l_pwd" /></td>
              </tr>
                <tr height="50">
                <td align="right">性别 &nbsp;</td>
                <td><input type="text" name="sex" value="" class="l_mem" /></td>
               </tr>
              <tr height="50">
