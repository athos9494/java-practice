...
public class AnimalMonitorImpl implements AnimalMonitor {
    ...
    public void printSightingsBy(int spotter) {
        for (Sighting thr:sightings) {
            if (thr.getSpotter()==spotter){
                System.out.println(thr.getAnimal());
            }
        }
    }
    ...
    public void printEndangered(List<String> animalNames, int dangerThreshold) {
        for(Sighting four : sightings){
            if (four.getCount() <= dangerThreshold){
                System.out.println(four.getAnimal());
            }
        }
    ...
    public List<Sighting> printSightingsInPeriod(int period) {
        ...
        for(Sighting five : sightings){
            if(five.getPeriod() == period){
